...
public interface RegistrationMethodsInterface {
     ...
     */
    void printArrayListToFile(ArrayList<CarOwner> inList, String inMsg) throws IOException;
     ...
     * @param inMsg Message specific to the array being printed
     */
    void printArrayToFile(CarOwner[] inArray, String inMsg) throws IOException;
